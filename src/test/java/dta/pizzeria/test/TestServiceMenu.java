...
public class TestServiceMenu {
    ...
    public void avant() {
        ...
        Produits dessert1 = new Produits("Eclair au Chocolat", 2F,  "chocolat.jpg",Produits.Type_Produit.DESSERT, null, null);
        Produits dessert2 = new Produits("Religieuse au Café", 3F, "chocolat.jpg", Produits.Type_Produit.DESSERT, null, null);
